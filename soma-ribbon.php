...
function komur_ribbon() {
	echo '<img src='.plugins_url( 'black-ribbon.png', __FILE__ ).' alt="Ülkemizde Yaşanan Terör Olaylarında Can Verenlerimize..."  title="Ülkemizde Yaşanan Terör Olaylarında Can Verenlerimize..." style="position: fixed; width:85px; bottom: 0; right: 0; z-index: 999999; cursor: pointer;" />';
}
